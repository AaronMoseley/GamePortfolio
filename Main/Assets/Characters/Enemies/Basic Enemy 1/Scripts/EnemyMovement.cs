...
public class EnemyMovement : MonoBehaviour
{
    ...
    void Jump()
    {
        ...
        else if (aiPath.desiredVelocity.y > jumpYVelBaseline && footCollider.colliding && currWaitTime >= jumpWaitTime && detectionState != "stationary" && detectionState != "shooting")
        {
            movingState = "jumping";
            currJumpTime = 0;

            if (detectionState == "patrolling")
            {
