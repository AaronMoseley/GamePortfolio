...
public class InGameMenuManager : MonoBehaviour
{
    ...
    void Update()
    {
        if(input.ButtonDown("Pause") && !player.GetComponentInChildren<Inventory>().invOpen && showing == "none" && !player.GetComponent<Movement>().talking)
        {
            ...
            showing = "pause";
        } else if(input.ButtonDown("Pause") && showing == "pause")
        {
            ...
            showing = "none";
        } else if(input.Button("Pause") && showing == "loads")
        {
            loadMenu.SetActive(false);
            showing = "pause";
        }

        if(input.ButtonDown("Escape") && showing == "options")
        {
            pauseMenu.SetActive(true);
            ...
            showing = "pause";
        } else if(input.ButtonDown("Escape") && showing == "bindings")
        {
            bindingMenu.SetActive(false);
            optionsMenu.SetActive(false);
